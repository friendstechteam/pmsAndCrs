package com.pms.crsEntities.entities;
...
public class ChaniInformation {
	...
	public ChaniInformation(@JsonProperty("tenant") String tenant,
	...
	public boolean equals(Object o) {
		...
		ChaniInformation that = (ChaniInformation) o;
